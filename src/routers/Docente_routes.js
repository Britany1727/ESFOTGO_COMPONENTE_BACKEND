...
import { validarRegistroDocente, validarMiddleware } from '../middlewares/validators.js'
const routerDocentes = Router()

//REGISTRO Y AUTENTICACIÓN
routerDocentes.post('/docente/registro', validarMiddleware(validarRegistroDocente), registroDocente)
