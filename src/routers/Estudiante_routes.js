...
import { verAula, listarAulas, listarOficinas, verOficina,listarEventos,verEvento, listarDocentes, verDocente, recuperarPasswordAdmin } from '../controllers/admin_controllers.js'
...
router.post('/estudiantes/registro',registroEstudiante)
