...
import {
    ...
    actualizarArista,
    eliminarArista
} from '../controllers/grafo_controllers.js';
...
// MAPA - Ubicaciones (público)
routerMapa.get('/mapa/ubicaciones', listarUbicaciones);
routerMapa.get('/mapa/categoria/:category', listarUbicacionesPorCategoria);
routerMapa.get('/mapa/ubicacion/:id', verUbicacion);
...
routerMapa.get('/mapa/grafo/nodos', obtenerNodosNavegacion);
routerMapa.get('/mapa/grafo', obtenerGrafo);
routerMapa.get('/mapa/grafo/aristas', listarAristas);
...
routerMapa.post('/admin/mapa/grafo/nodos', verificarTokenJWT, crearNodo);
routerMapa.delete('/admin/mapa/grafo/nodos/:id', verificarTokenJWT, eliminarNodo);
